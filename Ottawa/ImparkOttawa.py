...
driver.get('https://lots.impark.com/imp/en?latlng=45.42153,-75.697193&q=Ottawa%20ON%20Canada')
time.sleep(1)
...
for a in addresses:
    address.append(a.text + "Ottawa, ON")
...
df.to_csv('OttawaImpark.csv', index=False, encoding='utf-8')
